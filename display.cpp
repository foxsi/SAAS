...
void gl_display (void) {
    ...
    // draw larger circles
    gl_draw_circle(calib_center_x, NUM_YPIXELS - calib_center_y, 60 * 60 / arcsec_to_pixel, NUM_CIRCLE_SEGMENTS);
    gl_draw_circle(calib_center_x, NUM_YPIXELS - calib_center_y, 90 * 60 / arcsec_to_pixel, NUM_CIRCLE_SEGMENTS);
